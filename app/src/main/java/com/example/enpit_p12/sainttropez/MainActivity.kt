...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        when(item?.itemId){
            R.id.top -> {
                imageView2.setImageResource(R.drawable.toppage)
                return true
            }
            R.id.lunch01 -> {
                imageView2.setImageResource(R.drawable.lunch01)
                return true
            }
            R.id.lunch02 -> {
                imageView2.setImageResource(R.drawable.lunch02)
                return true
            }
            R.id.dinner01 -> {
                imageView2.setImageResource(R.drawable.dinner01)
                return true
            }
            R.id.dinner02 -> {
                imageView2.setImageResource(R.drawable.dinner02)
                return true
            }
        }
